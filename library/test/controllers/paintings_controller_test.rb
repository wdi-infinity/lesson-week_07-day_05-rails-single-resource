...
class PaintingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post paintings_url, params: { painting: { atrist: @painting.atrist, string: @painting.string, title: @painting.title } }
    end
  ...
  test "should update painting" do
    patch painting_url(@painting), params: { painting: { atrist: @painting.atrist, string: @painting.string, title: @painting.title } }
